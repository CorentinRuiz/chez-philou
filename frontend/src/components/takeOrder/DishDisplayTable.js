                    ...
                    <Grid item xs={6} key={index}>
                        <Paper className="menu-item" elevation={0} sx={{height: 100,}}>
                            <Box display="flex" justifyContent="space-between" alignItems="center"
                                 marginBottom="10px" marginLeft={1} marginRight={1}>
                                <Typography variant="h6">{<Title style={{margin: 0}}
                                                                 level={4}>{menuItem.shortName.charAt(0).toUpperCase() + menuItem.shortName.slice(1)}</Title>}</Typography>
                            ...
                            <Grid container justifyContent="center" alignItems="center" spacing={0}>
                                ...
                                <Grid item>
                                    <TextField type="number" variant="outlined" value={itemCounts[index]}
                                               onChange={(e) =>
                                ...
                                <Grid item>
                                    <IconButton color="primary" onClick={() => handleAddItem(index)}>
                                        <AddIcon/>
                                    </IconButton>
                                </Grid>
                            </Grid>
