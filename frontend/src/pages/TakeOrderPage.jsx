...
const TakeOrderPage = () => {
  ...
  const calculateWaitingTime = () => {
    return new Promise(async (resolve) => {
      ...
      const totalTime = itemTimes.reduce(
  ...
  const onCreateBill = () => {
    billModal(getGroupedItemByService(),(tableOrderId) =>{ createBillForTheTable(tableOrderId).then(() => {
        messageApi.success(`Facture bien créée`);
        navigate("/");
      });},tableOrderId, orderTotalPrice());
